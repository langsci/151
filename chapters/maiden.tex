...
\isi{vocalic alternations} in the verb root (or `stem'), such that one
...
alternation in vowel quality, phonologically conditioned by \isi{stress}. The
...
`morphomic'\is{morphome} in nature, being no longer determined by stress, but simply
...
prime example of `\isi{phonologically conditioned allomorphy}'. He
...
\caption{\emph{Dueir} in \ili{Savognin}}\\
\lsptoprule
...
The `defectiveness'\is{defectiveness} of \emph{dueir} is the effect, not the cause, of the
suppletion. All suppletive\is{suppletion} verbs whose morphology reflects the incursion
of forms of the paradigm\is{paradigm} of one lexeme on the paradigm of another are,
...
verb with its own full paradigm\is{paradigm} (and indeed with its own distinctive
...
\emph{historically}, defectiveness\is{defectiveness}: the Latin ancestor of \emph{esser}

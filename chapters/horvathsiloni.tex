...
may be felt more \isi{opaque} than those in (\ref{ex:horvath:2}--\ref{ex:horvath:a-b}). However, the degree of
...
The listing of (\ref{ex:horvath:7}--\ref{ex:horvath:a--b}) in the \isi{passive} participial form may well be due to
...
a non-idiomatic argument\is{arguments} (\ref{ex:horvath:20}--\ref{ex:horvath:a--b}). Moreover, the non-idiomatic element

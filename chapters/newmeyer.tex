...
\isi{`principles-and-parameters' (P\&P)} approach.
...
typology should be reducible to choice of values of \isi{parameters}. A major
...
of some language without asking the question of how principles of \isi{Case},
...
Let's say that we observe two Italian \isi{dialects}, one with a
...
Tying parameters to \isi{functional categories} was a strong conjecture in the
...
(2008) propose 47 parameters for \isi{DP} alone on the basis of 24 languages,
...
\ea \langinfo{Hixkaryana}{}{\citet{derbyshire1985}}\\
...
for OVS order.\is{word order} But in fact Baker rejects the idea that a special word
...
There are a number of ways that the assumptions of the Minimalist Program\is{Minimalist Program} have entailed
...
variation} in the years to come.
...
Alternatives to parameters are grounded approaches, \isi{epigenetic}
